...
namespace Outsourcing.Service
{
    ...
    public class BlogService : IBlogService
    {
        ...
        {
            var blogs = blogRepository.GetMany(b => !b.BlogCategory.IsStaticPage && !b.IsDeleted).OrderBy(b => b.Position);
            return blogs;
        }
        public IEnumerable<Blog> Get3BlogsPosition()
        {
            var blogs = blogRepository.GetMany(b => !b.BlogCategory.IsStaticPage && !b.IsDeleted).OrderBy(b => b.Position).Take(3);
            return blogs;
        }
          public IEnumerable<Blog> GetHomePageBlogs()
        {
            var blogs = blogRepository.
                GetMany(b => !b.BlogCategory.IsStaticPage && !b.IsDeleted && b.IsHomePage).
        ...
        {
            var blogs = blogRepository.GetMany(b => b.BlogCategory.IsStaticPage && !b.IsDeleted).OrderByDescending(b => b.DateCreated);
            return blogs;
        }
