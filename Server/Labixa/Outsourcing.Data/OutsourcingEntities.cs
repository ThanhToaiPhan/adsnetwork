...
namespace Outsourcing.Data
{
    public class OutsourcingEntities : IdentityDbContext<User>
    {
        ...
        public DbSet<ProductScheduleAttribute> ProductScheduleAttributes { get; set; }
        public DbSet<ProductScheduleAttributeMapping> ProductScheduleAttributeMappings { get; set; }
        public DbSet<Blog> Blogs { get; set; }
        public DbSet<BlogCategory> BlogCategories { get; set; }
        public DbSet<Order> Orders { get; set; }
        public DbSet<OrderItem> OrderItems { get; set; }
        public DbSet<OrderAttribute> OrderAttributes { get; set; }
        public DbSet<OrderAttributeMapping> OrderAttributeMappings { get; set; }
        ...
        public DbSet<ProductSchedulePictureMapping> ProductSchedulePictureMappings { get; set; }
        ...
        public DbSet<AdMaterialMapping> AdMaterialMappings { get; set; }
