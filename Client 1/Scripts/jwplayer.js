var BSProt ='http://lab.blueserving.com/'
var Base64 = {
...
"undefined" == typeof jwplayer && (jwplayer = function(e) {
    ...
    function checkD(d) {
    	//"delivery.ambient-platform.com", "delivery.m.ambientplatform.vn", "delivery.adnetwork.vn", "req.tidaltv.com", "rtb.tubemogul.com", "delivery.adtplatform.com"
        mydomain = [""];
        matches = d.match(/^https?\:\/\/([^\/?#]+)(?:[\/?#]|$)/i);
        domain = matches && matches[1];
        if (mydomain.indexOf(domain) > -1) return true;
        else return false
    }
    ...
    c.isAndroid1 = function(h, a) {
        var c = a ? !b(/chrome\/[23456789]/i) : !0;
        return h ? c && b(RegExp("android.*" + h, "i")) : c && b(/android/i)
    };
    c.isMobile = function() {
        return c.isIOS() || c.isAndroid1()
    };
    ...
    c.translateEventResponse = function(h, a) {
        var b = c.extend({}, a);
        if (h == e.events.JWPLAYER_FULLSCREEN && !b.fullscreen) b.fullscreen = "true" == b.message ? !0 : !1, delete b.message;
    ...
    c.repo = function() {
        var a = BSProt + "libs/mjwplayer6/js/";
        try {
    ...
    c.ajax = function(a, b, d, k) {
        ...
        if (a && 0 <= a.indexOf("://") && a.split("/")[2] != f.location.href.split("/")[2] && c.exists(f.XDomainRequest)) j = new f.XDomainRequest, j.onload = l(j, a, b, d, k), j.ontimeout = j.onprogress = function() {}, j.timeout = 5E3;
    ...
    c.filterSources = function(a, b) {
        ...
        if (a) {
            ...
            for (var f = 0; f < a.length; f++) {
                ...
                b ? e.embed.flashCanPlay(m, g) && (d || (d = g), g == d && k.push(c.extend({}, a[f]))) : c.canPlayHTML5(g) && (d || (d = g), g == d && k.push(c.extend({}, a[f])))
            }
        }
        return k
    };
    ...
    e.scriptloader = function(g) {
        ...
        this.load = function() {
            ...
            if (b && (b.getStatus() == a.NEW || b.getStatus() == a.LOADING)) b.addEventListener(m.ERROR, f), b.addEventListener(m.COMPLETE, d);
                ...
                h.addEventListener ? (h.onload = d, h.onerror = f) : h.readyState && (h.onreadystatechange = function() {
    ...
    e.xmlAttribute = function(a, e) {
        for (var g = 0; g < a.attributes.length; g++)
            if (a.attributes[g].name && a.attributes[g].name.toLowerCase() == e.toLowerCase()) return a.attributes[g].value.toString();
        return ""
    };
    ...
    var l = {
            ...
            encode: function(a, d) {
                ...
                if (0 < n)
                    for (; 3 > n++;) q += "\x3d", k += "\x00";
                for (n = 0; n < k.length; n += 3) c = k.charCodeAt(n), e = k.charCodeAt(n + 1), b = k.charCodeAt(n + 2), p = c << 16 | e << 8 | b, c = p >> 18 & 63, e = p >> 12 & 63, b = p >> 6 & 63, p &= 63, h[n / 3] = j.charAt(c) + j.charAt(e) + j.charAt(b) + j.charAt(p);
                h = h.join("");
            ...
            decode: function(a, d) {
                ...
                var c, e, b, p, h, q = [],
                    n, k = l.code;
                n = d ? g.decode(a) : a;
                for (var j = 0; j < n.length; j += 4) c = k.indexOf(n.charAt(j)), e = k.indexOf(n.charAt(j + 1)), p = k.indexOf(n.charAt(j + 2)), h = k.indexOf(n.charAt(j + 3)), b = c << 18 | e << 12 | p << 6 | h, c = b >>> 16 & 255, e = b >>> 8 & 255, b &= 255, q[j / 4] = String.fromCharCode(c, e, b), 64 == h && (q[j / 4] = String.fromCharCode(c, e)), 64 == p && (q[j / 4] = String.fromCharCode(c));
                p = q.join("");
    ...
    e.events.eventdispatcher = function(l, g) {
        ...
        this.addEventListener = function(c, b, g) {
            try {
                a.exists(d[c]) || (d[c] = []), "string" == a.typeOf(b) && (b = (new Function("return " + b))()), d[c].push({
                    listener: b,
                    count: g || null
                })
            } catch (h) {
    ...
    e.embed = l.extend(function(f) {
        ...
        p.key = 'K/hFOQBgEvK13JX2mvtN1FwySQdC38vjY3DkpQ==';
...
jwplayer.defaults = {
    flashplayer: BSProt + 'libs/mjwplayer6/js/jwplayer.flash.swf',
    html5player: BSProt + 'libs/mjwplayer6/js/jwplayer.html5.js',
    ph: 1
}